...
Kevin Huang
Oct 16th, 2025
Lab 9, whileloop and do-while loop
*/
...
int main(){
    ...
    cout<<"\n ------ example 6: while loop to validate a number ------"<<endl;
    do{
    cout<<"Enter a number between 10 and 20 inclusive: ";
    cin>>num;
    }
    ...
    cout<<"\n ------ example 7: while loop to validate a number ------"<<endl;
    // do-while to run the program again
    // program checks if a number is positive, negative, or zeo.
    int number;
    char choice = 'y';
    do{
        cout<<"Enter a number: ";
    ...
    while(true){
        ...
        if(w>balance){
            ...
            balance -= w;
            cout<<"Withdrawed $"<<w<<" The new blanace $"<<balance<<endl;
            break;
        }
    }
    ...
    int sum = 0;
    do{
        cout<<"Enter any number besides 0: ";
        cin>>a;
